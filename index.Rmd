...
1. New/Replacement, Repair/Maintenance, Upgrade and Other Costs for the Selected Vessel
    a. Propulsion Engine
...
2. Trip Expenses for the Selected Vessel
    a. Fuel 
    b. Bait
...
3. Crew Payment System for the Selected Vessel
...
5. Quota Costs and Revenues for the Selected Vessel
...
#gt() >- cols_width(gear_revenue_4, Gear=150)
#gear_revenue_4 |> dplyr::select(Gear, Response, Sample, Resp_Perc, Mean, Median, St.Dev)|> gt() |>
#                  cols_width(Gear ~ px(150),
#                  Response ~ px(100),
#                  Sample ~ px(100),
#                  Resp_Perc ~ px(100),
#                  Mean ~ px(100),
#                  Median ~ px(100),
#                  St.Dev ~ px(100))
knitr::kable(cbind(gear_revenue_4), "html") %>% kable_styling() %>% scroll_box(width = "100%")
...
3. Profits and Profit Margins by fishing fleet
