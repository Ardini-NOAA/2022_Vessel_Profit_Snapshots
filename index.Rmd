...
2. Vessel Costs for the Selected Vessel
    ...
    b. IFQ Cost Recovery Fees (Scallop vessels only)
    c. State and Federal Permits and/or License Renewal Fees
    d. Launch and Trailer Fees (Handgear vessels only)
...
3. Trip Expenses for the Selected Vessel
    ...
    g. Paralytic Shellfish Poison Testing (Hydraulic Dredge vessels only)
...
5. Overhead Costs
    ...
    i. Spotter Planes, Drones or Other Aerial Search Expenses (Seine vessels only)
...
#gear_revenue_4$Mean<- gsub("\\$ \\s*(\\d+)", "\\$\\1", gear_revenue_4$Mean)

gear_revenue_4$Median<-paste0("$",gear_revenue_4$Median)
#gear_revenue_4$Median<- gsub("\\$ \\s*(\\d+)", "\\$\\1", gear_revenue_4$Median)

gear_revenue_4$St.Dev<-paste0("$",gear_revenue_4$St.Dev)
#gear_revenue_4$St.Dev<- gsub("\\$ \\s*(\\d+)", "\\$\\1", gear_revenue_4$St.Dev)

gear_revenue_4$Resp_Perc<-paste0(gear_revenue_4$Response_Rate,"%")
#gear_revenue_4$Resp_Perc <- str_replace_all(gear_revenue_4$Resp_Perc, " ", "")
...
#gear_fmp_revenue_5<- kable(gear_fmp_revenue_4, caption = "Revenue by Primary Gear/Fishery") %>% kable_styling(font_size = 16) %>% #kableExtra::scroll_box(width = "100%") %>% column_spec(1, width = "1in")
#knitr::kable(gear_fmp_revenue_4, caption = "Revenue by Primary Gear/Fishery") %>% kable_styling(font_size = 16) %>% kableExtra::scroll_box(width = "100%") #%>% column_spec(1, width = "3in")
...
gear_dist4<- subset(gear_dist3a, Gear== "Dredge_Scallop" | Gear== "Gillnet" | Gear== "Handgear")
ggplot(data=gear_dist4, aes(x="", y=percent, fill=Category)) + geom_bar(width = 1, stat = "identity") + coord_polar("y", start=0) + facet_grid(.~Gear) + theme_void() + geom_text(aes(label=perc), position = position_stack(vjust = 0.5), size=3) + theme(legend.text = element_text(size=12), legend.title = element_text(size=12), strip.text.x = element_text(size=11), plot.margin = margin(t=0, r=0, b=0, l=0, unit ="pt")) + scale_fill_manual(values=c("palegreen2", "palegreen3", "steelblue1", "dodgerblue","steelblue3" ))
```

```{r, fig.width=8, fig.height=8, echo=FALSE, results='hide'}
gear_dist5<- subset(gear_dist3a, Gear== "Longline" | Gear== "Pot/Trap" | Gear== "Trawl")
...
fmp_dist4<- subset(fmp_dist3a, Fishery== "Channeled Whelk" | Fishery== "Dogfish" | Fishery== "Fluke, BSB, Scup")
...
```{r, fig.width=8, fig.height=8, echo=FALSE, results='hide'}
fmp_dist5<- subset(fmp_dist3a, Fishery== "Groundfish" | Fishery== "Herring" | Fishery== "Highly Migratory Species")
ggplot(data=fmp_dist5, aes(x="", y=percent, fill=Category)) + geom_bar(width = 1, stat = "identity") + coord_polar("y", start=0) + facet_grid(.~Fishery) + theme_void() + geom_text(aes(label=perc), position = position_stack(vjust = 0.5), size=3) + theme(legend.text = element_text(size=12), legend.title = element_text(size=12), strip.text.x = element_text(size=11)) + scale_fill_manual(values=c("palegreen2", "palegreen3", "steelblue1", "dodgerblue","steelblue3" ))
```

```{r, fig.width=8, fig.height=8, echo=FALSE, results='hide'}
fmp_dist6<- subset(fmp_dist3a, Fishery== "Lobster" | Fishery== "Monkfish" | Fishery== "Scallop")
ggplot(data=fmp_dist6, aes(x="", y=percent, fill=Category)) + geom_bar(width = 1, stat = "identity") + coord_polar("y", start=0) + facet_grid(.~Fishery) + theme_void() + geom_text(aes(label=perc), position = position_stack(vjust = 0.5), size=3) + theme(legend.text = element_text(size=12), legend.title = element_text(size=12), strip.text.x = element_text(size=11)) + scale_fill_manual(values=c("palegreen2", "palegreen3", "steelblue1", "dodgerblue","steelblue3" ))
```

```{r, fig.width=8, fig.height=8, echo=FALSE, results='hide'}
fmp_dist7<- subset(fmp_dist3a, Fishery== "Squid, Mackerel, Butterfish" | Fishery== "Striped Bass")
ggplot(data=fmp_dist7, aes(x="", y=percent, fill=Category)) + geom_bar(width = 1, stat = "identity") + coord_polar("y", start=0) + facet_grid(.~Fishery) + theme_void() + geom_text(aes(label=perc), position = position_stack(vjust = 0.5), size=3) + theme(legend.text = element_text(size=12), legend.title = element_text(size=12), strip.text.x = element_text(size=11)) + scale_fill_manual(values=c("palegreen2", "palegreen3", "steelblue1", "dodgerblue","steelblue3" ))
```
...
gear_fmp_dist4<- subset(gear_fmp_dist3a, Gear_Fishery== "Dredge_Scallop-Scallop" | Gear_Fishery== "Gillnet-Monkfish" | Gear_Fishery== "Gillnet-Other")
...
```{r, fig.width=8, fig.height=8, echo=FALSE, results='hide'}
gear_fmp_dist5<- subset(gear_fmp_dist3a, Gear_Fishery== "Handgear-Fluke, BSB, Scup" | Gear_Fishery== "Handgear-Highly Migratory Species" | Gear_Fishery== "Handgear-Other")
ggplot(data=gear_fmp_dist5, aes(x="", y=percent, fill=Category)) + geom_bar(width = 1, stat = "identity") + coord_polar("y", start=0) + facet_grid(.~Gear_Fishery) + theme_void() + geom_text(aes(label=perc), position = position_stack(vjust = 0.5), size=3) + theme(legend.text = element_text(size=12), legend.title = element_text(size=12), strip.text.x = element_text(size=11)) + scale_fill_manual(values=c("palegreen2", "palegreen3", "steelblue1", "dodgerblue","steelblue3"))
```

```{r, fig.width=8, fig.height=8, echo=FALSE, results='hide'}
gear_fmp_dist6<- subset(gear_fmp_dist3a, Gear_Fishery== "Handgear-Striped Bass" | Gear_Fishery== "Longline-Highly Migratory Species" | Gear_Fishery== "Pot/Trap-Fluke, BSB, Scup")
ggplot(data=gear_fmp_dist6, aes(x="", y=percent, fill=Category)) + geom_bar(width = 1, stat = "identity") + coord_polar("y", start=0) + facet_grid(.~Gear_Fishery) + theme_void() + geom_text(aes(label=perc), position = position_stack(vjust = 0.5), size=3) + theme(legend.text = element_text(size=12), legend.title = element_text(size=12), strip.text.x = element_text(size=11)) + scale_fill_manual(values=c("palegreen2", "palegreen3", "steelblue1", "dodgerblue","steelblue3"))
```

```{r, fig.width=8, fig.height=8, echo=FALSE, results='hide'}
gear_fmp_dist7<- subset(gear_fmp_dist3a, Gear_Fishery== "Pot/Trap-Lobster" | Gear_Fishery== "Pot/Trap-Whelk" | Gear_Fishery== "Trawl-Fluke, BSB, Scup")
ggplot(data=gear_fmp_dist7, aes(x="", y=percent, fill=Category)) + geom_bar(width = 1, stat = "identity") + coord_polar("y", start=0) + facet_grid(.~Gear_Fishery) + theme_void() + geom_text(aes(label=perc), position = position_stack(vjust = 0.5), size=3) + theme(legend.text = element_text(size=12), legend.title = element_text(size=12), strip.text.x = element_text(size=11)) + scale_fill_manual(values=c("palegreen2", "palegreen3", "steelblue1", "dodgerblue","steelblue3"))
```

```{r, fig.width=8, fig.height=8, echo=FALSE, results='hide'}
gear_fmp_dist8<- subset(gear_fmp_dist3a, Gear_Fishery== "Trawl-Groundfish" | Gear_Fishery== "Trawl-Other" | Gear_Fishery== "Trawl-Squid, Mackerel, Butterfish")
ggplot(data=gear_fmp_dist8, aes(x="", y=percent, fill=Category)) + geom_bar(width = 1, stat = "identity") + coord_polar("y", start=0) + facet_grid(.~Gear_Fishery) + theme_void() + geom_text(aes(label=perc), position = position_stack(vjust = 0.5), size=3) + theme(legend.text = element_text(size=12), legend.title = element_text(size=12), strip.text.x = element_text(size=11)) + scale_fill_manual(values=c("palegreen2", "palegreen3", "steelblue1", "dodgerblue","steelblue3"))
```
